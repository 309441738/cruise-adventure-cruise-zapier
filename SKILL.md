---
name: cruise-adventure-cruise
title: cruise-adventure-cruise
description: 为喜欢冒险的旅行者推荐刺激的邮轮产品，体验不同寻常的旅程。
kind: MCP
version: 0.1.0
published_with: cruiseskillbridge
---

# cruise-adventure-cruise

> 为喜欢冒险的旅行者推荐刺激的邮轮产品，体验不同寻常的旅程。
...
```json
{ "input": "...", "skill": "cruise-adventure-cruise" }
```
